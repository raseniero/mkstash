		...
		<div class="row">
			<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
				<div class="fr__prize__inner">
					...
					<a class="fr__btn" href="index.html">Read More</a>
				</div>
			</div>
			<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
					...
					<div class="category">
						...
						<div class="fr__hover__info">
							<ul class="product__action">
								...
								<li><a href="index.html"><i class="icon-shuffle icons"></i></a></li>
							</ul>
						</div>
			...
			<div class="col-md-12">
				<div class="ht__brand__inner">
					<ul class="brand__list owl-carousel clearfix">
						<li><a href="index.html"><img src="images/brand/1.png" alt="brand images"></a></li>
						<li><a href="index.html"><img src="images/brand/2.png" alt="brand images"></a></li>
						<li><a href="index.html"><img src="images/brand/3.png" alt="brand images"></a></li>
						<li><a href="index.html"><img src="images/brand/4.png" alt="brand images"></a></li>
						<li><a href="index.html"><img src="images/brand/5.png" alt="brand images"></a></li>
						<li><a href="index.html"><img src="images/brand/5.png" alt="brand images"></a></li>
						<li><a href="index.html"><img src="images/brand/1.png" alt="brand images"></a></li>
						<li><a href="index.html"><img src="images/brand/2.png" alt="brand images"></a></li>
					</ul>
